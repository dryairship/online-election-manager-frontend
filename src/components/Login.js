...
export default function Login(props) {
  ...
  const login = () => {
    ...
    let adminpasswordVal = document.getElementById('l-adminpassword').value;
    let captchaValue = document.getElementById('l-captcha').value;
    let passwordHash = sha(sha(sha(passwordVal)));
    let adminpasswordHash = sha(sha(sha(adminpasswordVal)));
    ...
    formData.append('adminpass', adminpasswordHash);
    ...
    <Container component='main' maxWidth='xs'>
      ...
      <div className={classes.paper}>
        ...
        <form className={classes.form} noValidate>
          ...
          <TextField variant='outlined' margin='normal' required fullWidth id='l-captcha' label='CAPTCHA' name='captcha' autoFocus />
          <TextField variant='outlined' margin='normal' required fullWidth id='l-roll' label='Roll Number' name='roll' autoComplete='roll' />
          <TextField variant='outlined' margin='normal' required fullWidth name='password' label='Password' type='password' id='l-password' autoComplete='current-password' />
          <TextField variant='outlined' margin='normal' required fullWidth name='adminpassword' label='Admin Password' type='password' id='l-adminpassword' />
          <Grid container justify='center'>
            <Button type='button' variant='contained' color='primary' onClick={login} className={classes.submit}>
              Sign In
            </Button>
          </Grid>
        </form>
