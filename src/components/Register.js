		...
		<Container component='main' maxWidth='xs'>
			...
			<div className={classes.paper}>
				...
				<form className={classes.form} noValidate id='registration-form'>
					...
					<TextField variant='outlined' margin='normal' required fullWidth id='r-captcha' label='CAPTCHA' name='captcha' autoFocus />
					<TextField variant='outlined' margin='normal' required fullWidth id='r-roll' label='Roll Number' name='roll' autoComplete='roll' />
					<TextField variant='outlined' margin='normal' required fullWidth name='password' label='Password' type='password' id='r-password' autoComplete='current-password' />
					<TextField variant='outlined' margin='normal' required fullWidth name='confirm-password' label='Confirm Password' type='password' id='r-confirm-password' />
					<TextField variant='outlined' margin='normal' required fullWidth id='r-verification-code' label='Verification Code' name='verification-code' />
					<Grid container justify='center'>
						<Button type='button' variant='contained' color='primary' onClick={registerUser} className={classes.submit}>
							Register
						</Button>
					</Grid>
				</form>
